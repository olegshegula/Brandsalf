...
public interface UserHelper {
	...
	boolean isPullDownMenuContentCorrect(String s1, String s2, String s3,
			String s4, String s5);

	boolean isPullDownMenuCategoryFileCorrect(String s1, String s2, String s3,
			String s4, String s5);

	void search(Files filename);
